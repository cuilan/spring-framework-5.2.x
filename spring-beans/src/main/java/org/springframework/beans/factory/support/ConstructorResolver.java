...
class ConstructorResolver {
	...
	public BeanWrapper autowireConstructor(String beanName, RootBeanDefinition mbd,
		...
		if (constructorToUse == null || argsToUse == null) {
			...
			int minNrOfArgs;
			if (explicitArgs != null) {
				// 如果传入的参数不等于空，最小长度就是传入的参数长度
				minNrOfArgs = explicitArgs.length;
			} else {
				// 实例一个构造方法参数对象，用来存放构造方法的参数值
			...
			// 对构造方法进行排序
			// 排序规则：访问权大的放在前面，参数多的放在前面
			// public Test(Object o1, Object o2, Object o3)
			// public Test(Object o1, Object o2)
			// public Test(Object o1)
			// protected Test(Object o1, Object o2, Object o3)
			// protected Test(Object o1, Object o2)
			// protected Test(Object o1)
